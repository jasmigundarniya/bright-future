...
import WebinarSwiper from "./WebinarSwiper";

const Webinar = ({ id }) => {
  const webinarDate = new Date("2025-09-01T10:00:00");

  return (
    <section id={id} className="bg-[#FFF5E1] my-8 py-8 md:py-16">
      <div className="container mx-auto px-5">
        <div className="flex justify-between items-center mb-6">
          <ScrollAnimationWrapper direction="left">
            <h2 className="md:text-[45px] text-[25px] text-center md:text-start text-darkBlack font-bold mb-2 md:mb-4">
        ...
        <div className="lg:grid grid-cols-1 md:grid-cols-3 gap-6 hidden">
          <ScrollAnimationWrapper direction="left">
