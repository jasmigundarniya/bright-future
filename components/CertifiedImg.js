...
const Certified = () => {
  return (
    <section className="container mx-auto px-5 mt-10 mb-16">
      <div className="grid grid-cols-2 lg:grid-cols-4 lg:gap-4 items-center justify-center bg-[#F8F8F8] py-4 rounded-[30px] px-8">
